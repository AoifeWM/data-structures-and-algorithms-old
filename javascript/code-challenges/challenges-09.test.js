...
const hasChildrenValues = (arr, character) => {
  return arr.find(obj => obj.name === character).children !== undefined;
};
...
const hasChildrenEntries = (arr, character) => {
  if(arr.find(obj => obj.name === character) !== undefined){
    return arr.find(obj => obj.name === character).children !== (undefined || []);
  }
  return false;
};
...
const totalCharacters = (arr) => {
  ...
  arr.forEach(obj => {
    obj.children !== undefined ? total += obj.children.length : 0;
    obj.spouse !== null ? total += 1 : 0;
  });
  return total;
};
...
const houseSize = (arr) => {
  ...
  arr.forEach(obj => {
    ...
    obj.children !== undefined ? total += obj.children.length : 0;
    obj.spouse !== null ? total += 1 : 0;
    sizes.push({house: obj.house, members: total});
    // ---------------
    // Why doesn't it want me to check for duplicate houses? regardless here is the code to do so because I already wrote it:
    // ---------------
    // if(sizes.find(house => house.house === obj.house) === undefined){
    //   total = 1;
    //   obj.children !== undefined ? total += obj.children.length : 0;
    //   obj.spouse !== null ? total += 1 : 0;
    //   sizes.push({house: obj.house, members: total});
    ...
    //   obj.children !== undefined ? total += obj.children.length : 0;
    //   obj.spouse !== null ? total += 1 : 0;
    //   sizes.find(house => house.house === obj.house).members += total;
    // }
  });
  return sizes;
};
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach(obj => {
    ...
    total = 1;
    obj.children !== undefined ? total += obj.children.length : 0;
    obj.spouse !== null && !deceasedSpouses.includes(obj.spouse) ? total += 1 : 0;
    survivors.push({house: obj.house, members: total});
  });
  return survivors;
};
